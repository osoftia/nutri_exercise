...
class RoutineList extends StatelessWidget {
  const RoutineList({super.key, required this.routines, this.onRoutineTap});

  final List<WorkoutDay> routines;
  final ValueChanged<WorkoutDay>? onRoutineTap;

  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        for (final day in routines) _RoutineTile(day: day, onTap: onRoutineTap),
      ],
    );
  }
}
...
class _RoutineTile extends StatelessWidget {
  const _RoutineTile({required this.day, this.onTap});

  final WorkoutDay day;
  final ValueChanged<WorkoutDay>? onTap;
